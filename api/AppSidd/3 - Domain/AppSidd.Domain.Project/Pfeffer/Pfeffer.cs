...
{
    public class Pfeffer
    {
        private readonly INotificationHandler _notificationHandler;

        internal Pfeffer() { }
        internal Pfeffer(INotificationHandler notificationHandler)
        {
            _notificationHandler = notificationHandler;
        }
        public Guid PfefferId { get; set; }
        ...
        public void Specify()
        {
            var specifications = new PfefferSpecifications();
